...
complete -c bbcli -n "__fish_bbcli_needs_command" -f -a "recovery" -d 'Recover older requester revisions and manage recovery mode'
...
complete -c bbcli -n "__fish_bbcli_using_subcommand init" -l recovery-mode -d 'recovery_mode blocks outgoing publication until recovery is finished'
...
complete -c bbcli -n "__fish_bbcli_using_subcommand peer; and not __fish_seen_subcommand_from connect pin unpin list help" -s h -l help -d 'Print help'
complete -c bbcli -n "__fish_bbcli_using_subcommand peer; and not __fish_seen_subcommand_from connect pin unpin list help" -f -a "connect" -d 'Add a peer onion identifier to the daemon\'s known peer list'
complete -c bbcli -n "__fish_bbcli_using_subcommand peer; and not __fish_seen_subcommand_from connect pin unpin list help" -f -a "pin" -d 'Pin a tracked peer so local policy treats it as operator-protected'
complete -c bbcli -n "__fish_bbcli_using_subcommand peer; and not __fish_seen_subcommand_from connect pin unpin list help" -f -a "unpin" -d 'Remove an existing operator pin from a tracked peer'
complete -c bbcli -n "__fish_bbcli_using_subcommand peer; and not __fish_seen_subcommand_from connect pin unpin list help" -f -a "list" -d 'Print the daemon\'s current peer inventory'
complete -c bbcli -n "__fish_bbcli_using_subcommand peer; and not __fish_seen_subcommand_from connect pin unpin list help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c bbcli -n "__fish_bbcli_using_subcommand recovery; and not __fish_seen_subcommand_from run finish help" -s h -l help -d 'Print help'
complete -c bbcli -n "__fish_bbcli_using_subcommand recovery; and not __fish_seen_subcommand_from run finish help" -f -a "run" -d 'Recover older requester revisions from peers and merge them locally'
complete -c bbcli -n "__fish_bbcli_using_subcommand recovery; and not __fish_seen_subcommand_from run finish help" -f -a "finish" -d 'Finish recovery mode and allow publication from the current generation'
complete -c bbcli -n "__fish_bbcli_using_subcommand recovery; and not __fish_seen_subcommand_from run finish help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c bbcli -n "__fish_bbcli_using_subcommand recovery; and __fish_seen_subcommand_from run" -s h -l help -d 'Print help'
complete -c bbcli -n "__fish_bbcli_using_subcommand recovery; and __fish_seen_subcommand_from finish" -s h -l help -d 'Print help'
complete -c bbcli -n "__fish_bbcli_using_subcommand recovery; and __fish_seen_subcommand_from help" -f -a "run" -d 'Recover older requester revisions from peers and merge them locally'
complete -c bbcli -n "__fish_bbcli_using_subcommand recovery; and __fish_seen_subcommand_from help" -f -a "finish" -d 'Finish recovery mode and allow publication from the current generation'
...
complete -c bbcli -n "__fish_bbcli_using_subcommand help; and not __fish_seen_subcommand_from state init unlock stop peer file contract recovery config help" -f -a "recovery" -d 'Recover older requester revisions and manage recovery mode'
...
complete -c bbcli -n "__fish_bbcli_using_subcommand help; and __fish_seen_subcommand_from recovery" -f -a "run" -d 'Recover older requester revisions from peers and merge them locally'
complete -c bbcli -n "__fish_bbcli_using_subcommand help; and __fish_seen_subcommand_from recovery" -f -a "finish" -d 'Finish recovery mode and allow publication from the current generation'
