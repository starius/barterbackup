...
complete -c bbcli -n "__fish_bbcli_using_subcommand help; and not __fish_seen_subcommand_from state init unlock stop peer file contract config help" -f -a "state" -d 'Print daemon state'
complete -c bbcli -n "__fish_bbcli_using_subcommand help; and not __fish_seen_subcommand_from state init unlock stop peer file contract config help" -f -a "init" -d 'Initialize daemon storage with the main password or complete one recovery-mode initialization'
complete -c bbcli -n "__fish_bbcli_using_subcommand help; and not __fish_seen_subcommand_from state init unlock stop peer file contract config help" -f -a "unlock" -d 'Send the main password to the daemon unlock path'
complete -c bbcli -n "__fish_bbcli_using_subcommand help; and not __fish_seen_subcommand_from state init unlock stop peer file contract config help" -f -a "stop" -d 'Ask the daemon to shut down gracefully'
complete -c bbcli -n "__fish_bbcli_using_subcommand help; and not __fish_seen_subcommand_from state init unlock stop peer file contract config help" -f -a "peer" -d 'Manage known peers'
complete -c bbcli -n "__fish_bbcli_using_subcommand help; and not __fish_seen_subcommand_from state init unlock stop peer file contract config help" -f -a "file" -d 'Manage files in the latest encrypted content blob'
complete -c bbcli -n "__fish_bbcli_using_subcommand help; and not __fish_seen_subcommand_from state init unlock stop peer file contract config help" -f -a "contract" -d 'Inspect and drive contracts with peers'
complete -c bbcli -n "__fish_bbcli_using_subcommand help; and not __fish_seen_subcommand_from state init unlock stop peer file contract config help" -f -a "config" -d 'Read or update daemon configuration'
complete -c bbcli -n "__fish_bbcli_using_subcommand help; and not __fish_seen_subcommand_from state init unlock stop peer file contract config help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
