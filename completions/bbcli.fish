...
complete -c bbcli -n "__fish_bbcli_using_subcommand peer; and not __fish_seen_subcommand_from connect ping pin unpin list check help" -s h -l help -d 'Print help'
complete -c bbcli -n "__fish_bbcli_using_subcommand peer; and not __fish_seen_subcommand_from connect ping pin unpin list check help" -f -a "connect" -d 'Add a peer onion identifier to the daemon\'s known peer list'
complete -c bbcli -n "__fish_bbcli_using_subcommand peer; and not __fish_seen_subcommand_from connect ping pin unpin list check help" -f -a "ping" -d 'Validate that one peer onion service answers HealthCheck live'
complete -c bbcli -n "__fish_bbcli_using_subcommand peer; and not __fish_seen_subcommand_from connect ping pin unpin list check help" -f -a "pin" -d 'Pin a tracked peer so local policy treats it as operator-protected'
complete -c bbcli -n "__fish_bbcli_using_subcommand peer; and not __fish_seen_subcommand_from connect ping pin unpin list check help" -f -a "unpin" -d 'Remove an existing operator pin from a tracked peer'
complete -c bbcli -n "__fish_bbcli_using_subcommand peer; and not __fish_seen_subcommand_from connect ping pin unpin list check help" -f -a "list" -d 'Print the daemon\'s current peer inventory'
complete -c bbcli -n "__fish_bbcli_using_subcommand peer; and not __fish_seen_subcommand_from connect ping pin unpin list check help" -f -a "check" -d 'Check one peer\'s current copy of our latest local revision'
complete -c bbcli -n "__fish_bbcli_using_subcommand peer; and not __fish_seen_subcommand_from connect ping pin unpin list check help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c bbcli -n "__fish_bbcli_using_subcommand peer; and __fish_seen_subcommand_from connect" -s h -l help -d 'Print help'
complete -c bbcli -n "__fish_bbcli_using_subcommand peer; and __fish_seen_subcommand_from ping" -s h -l help -d 'Print help'
...
complete -c bbcli -n "__fish_bbcli_using_subcommand peer; and __fish_seen_subcommand_from help" -f -a "ping" -d 'Validate that one peer onion service answers HealthCheck live'
...
complete -c bbcli -n "__fish_bbcli_using_subcommand help; and __fish_seen_subcommand_from peer" -f -a "ping" -d 'Validate that one peer onion service answers HealthCheck live'
